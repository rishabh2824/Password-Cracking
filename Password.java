...
public class Password {
  ...
  public int compareTo(Password other, Attribute a) {
    return switch(a){
      case OCCURRENCE -> this.occurrences-other.occurrences;
      case STRENGTH_RATING -> (int)(this.strengthRating- other.strengthRating);
      case HASHED_PASSWORD -> this.hashedPassword.compareTo(other.hashedPassword);
    };
  }
}
